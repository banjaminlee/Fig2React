...
const Info: React.FC<SvgProps> = ({ color }) => {
  ...
  return (
    ...
    >
      <g>
        <path
          d="M68.6,56.2c-1.5,0-2.9,0.7-4,1.9c-1.1,1.2-1.7,2.9-1.7,4.6v25.9c0,1.7,0.6,3.4,1.7,4.6c1.1,1.2,2.5,1.9,4,1.9
        ...
        />
        <path
          d="M70.8,38.8c-1.4-0.6-2.9-0.6-4.3,0c-0.7,0.3-1.3,0.7-1.9,1.2c-0.5,0.6-0.9,1.2-1.2,1.9c-0.3,0.7-0.5,1.4-0.5,2.2
        ...
        />
        <path
          d="M121,45c-2.8-6.9-7-13.1-12.3-18.4c-5.3-5.3-11.5-9.4-18.4-12.3C83.4,11.5,76,10,68.6,10c-11.2,0-22.2,3.3-31.5,9.6
